 ...
 * 
 *         Responsibilities of class: To test the functionality of the
 *         WeeklyTimeBlock class, including conflict checking and updating time
 *         block values.
 * 
 */
class WeeklyTimeBlockTest
{
	private WeeklyTimeBlock block1; // A weeklytimeblocktest has-a block 1
	private WeeklyTimeBlock block2; // A weeklytimeblocktest has-a block 2

	@BeforeEach
	public void setUp()
	{
		block1 = new WeeklyTimeBlock(List.of(DayOfWeek.MONDAY),
				LocalTime.of(9, 0), LocalTime.of(10, 0));

		block2 = new WeeklyTimeBlock(List.of(DayOfWeek.MONDAY),
	...
	public void testConflict_OverlappingTimes()
	{
		WeeklyTimeBlock overlapping = new WeeklyTimeBlock(
				List.of(DayOfWeek.MONDAY), LocalTime.of(9, 30),
				LocalTime.of(10, 30));
	...
	public void testNoConflict_DifferentDays()
	{
		WeeklyTimeBlock differentDay = new WeeklyTimeBlock(
				List.of(DayOfWeek.TUESDAY), LocalTime.of(9, 0),
				LocalTime.of(10, 0));
	...
	{
		block1.setWeeklyTimeBlock(List.of(DayOfWeek.FRIDAY),
