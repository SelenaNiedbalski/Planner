...
class ScheduleEdgeCaseTest
{
    ...
    private ScheduleGeneratorRepository repository;
    private FileService fileService;
    private FakeUserDataRepository userRepo;
    ...
    public void setUp()
    {
        ...
        fileService = new FileService(userRepo);

        generator = new ScheduleGenerator(loadingScreen);

        generator.setScheduleGeneratorReposAndFileService(
                userRepo,
                repository,
                fileService
        );
    ...
    private List<Course> buildCourses()
    {
        ...
        courses.add(new TestCourse("A","A1", List.of(DayOfWeek.MONDAY), LocalTime.of(9,0), LocalTime.of(10,0),3));
        courses.add(new TestCourse("B","B1", List.of(DayOfWeek.MONDAY), LocalTime.of(10,0), LocalTime.of(11,0),3));
        courses.add(new TestCourse("C","C1", List.of(DayOfWeek.MONDAY), LocalTime.of(11,0), LocalTime.of(12,0),3));
        courses.add(new TestCourse("D","D1", List.of(DayOfWeek.MONDAY), LocalTime.of(12,0), LocalTime.of(13,0),3));
        courses.add(new TestCourse("E","E1", List.of(DayOfWeek.MONDAY), LocalTime.of(13,0), LocalTime.of(14,0),3));
    ...
    public void testNoValidSchedulesPossible()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            impossibleCourses.add(new TestCourse(
                    "C"+i,
                    "ID"+i,
                    List.of(DayOfWeek.MONDAY),
                    LocalTime.of(9,0),
