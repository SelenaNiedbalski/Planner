 ...
 * 
 *         Responsibilities of class: To represent the view where the student
 *         will input the course information for each course they want to add to
 *         their planner, including the course name, if the course is required
 *         or not, the course type, and the file path to a CSV file containing
 *         the available classes for that course. The student will also be able
 *         to navigate back to the previous view, save their current progress,
 *         and move on to the next course info view or the planner view from
 *         this view.
 * 
...
public class CourseInfoView extends JFrame
{
	...
	// Instance Variables
	private AppController appController; // A course info view has-an app
											// controller

	// Course number label IV
	private JLabel courseNumberLabel; // A course info view has-a course number

	// Course name IVs
	private JTextField courseName; // A course info view has-a course name
	private JLabel courseNameError; // A course info view has-a course name
									// error label

	// Required course radio buttons IVs
	private JRadioButton yesButton; // A course info view has-a yes button
	private JRadioButton noButton; // A course info view has-a no button
	private ButtonGroup requiredButtonGroup; // A course info view has-a
												// required button group
	private JLabel requiredCourseError; // A course info view has-a required
										// course error label

	// Course type radio buttons IVs
	// Science
	private JRadioButton biologyRadioButton; // A course info view has-a biology
												// radio button
	private JRadioButton chemistryRadioButton; // A course info view has-a
												// chemistry radio button
	private JRadioButton physicsRadioButton; // A course info view has-a physics
												// radio button
	private JRadioButton environmentalScienceRadioButton; // A course info view
															// has-a
															// environmental
															// science radio
															// button
	private JRadioButton otherScienceRadioButton; // A course info view has-a
													// other science radio
													// button
	// Tech
	private JRadioButton computerScienceRadioButton; // A course info view has-a
														// computer science
														// radio button
	private JRadioButton informationTechnologyRadioButton; // A course info view
															// has-a information
															// technology radio
															// button
	private JRadioButton computerInformationSystemsRadioButton; // A course info
																// view has-a
																// computer
																// information
																// systems radio
																// button
	private JRadioButton cybersecurityAndInfoAssuranceRadioButton; // A course
																	// info view
																	// has-a
																	// cybersecurity
																	// and
																	...
																	// radio
																	// button
	private JRadioButton dataScienceAndAnalyticsRadioButton; // A course info
																// view has-a
																// data science
																// and analytics
																// radio button
	private JRadioButton softwareEngineeringAndDevelopmentRadioButton; // A
																		// course
																		// info
																		// view
																		// has-a
																		...
																		// radio
																		// button
	private JRadioButton computerEngineeringRadioButton; // A course info view
															// has-a computer
															// engineering radio
															// button
	private JRadioButton otherTechRadioButton; // A course info view has-a other
												// tech radio button
	// Engineering
	private JRadioButton civilEngineeringRadioButton; // A course info view
														// has-a civil
														// engineering radio
														// button
	private JRadioButton mechanicalEngineeringRadioButton; // A course info view
															// has-a mechanical
															// engineering radio
															// button
	private JRadioButton electricalEngineeringRadioButton; // A course info view
															// has-a electrical
															// engineering radio
															// button
	private JRadioButton chemicalEngineeringRadioButton; // A course info view
															// has-a chemical
															// engineering radio
															// button
	private JRadioButton otherEngineeringRadioButton; // A course info view
														// has-a other
														// engineering radio
														// button
	// Math
	private JRadioButton coreMathRadioButton; // A course info view has-a core
												// math radio button
	private JRadioButton pureMathRadioButton; // A course info view has-a pure
												// math radio button
	private JRadioButton appliedMathRadioButton; // A course info view has-a
													// applied math radio button
	private JRadioButton otherMathRadioButton; // A course info view has-a other
												// math radio button
	// Liberal Arts
	private JRadioButton historyRadioButton; // A course info view has-a history
												// radio button
	private JRadioButton literatureRadioButton; // A course info view has-a
												// literature radio button
	private JRadioButton philosophyRadioButton; // A course info view has-a
												// philosophy radio button
	private JRadioButton psychologyRadioButton; // A course info view has-a
												// psychology radio button
	private JRadioButton sociologyRadioButton; // A course info view has-a
												// sociology radio button
	private JRadioButton politicalScienceRadioButton; // A course info view
														// has-a political
														// science radio button
	private JRadioButton justiceAdministrationRadioButton; // A course info view
															// has-a justice
															// administration
															// radio button
	private JRadioButton otherLiberalArtsRadioButton; // A course info view
														// has-an other liberal
														// arts radio button
	// Professional
	private JRadioButton businessRadioButton; // A course info view has-a
												// business radio button
	private JRadioButton healthcareRadioButton; // A course info view has-a
												// healthcare radio button
	private JRadioButton lawRadioButton; // A course info view has-a law radio
											// button
	private JRadioButton educationRadioButton; // A course info view has-a
												// education radio button
	private JRadioButton vocationalRadioButton; // A course info view has-a
												// vocational radio button
	private JRadioButton agricultureRadioButton; // A course info view has-a
													// agriculture radio button
	private JRadioButton otherProfessionalRadioButton; // A course info view
														// has-a other
														// professional radio
														// button
	// Creative Arts and Electives
	private JRadioButton visualArtsAndDesignRadioButton; // A course info view
															// has-a visual arts
															// and design radio
															// button
	private JRadioButton foreignLanguageRadioButton; // A course info view has-a
														// foreign language
														// radio button
	private JRadioButton culinaryArtsRadioButton; // A course info view has-a
													// culinary arts radio
													// button
	private JRadioButton communicationRadioButton; // A course info view has-a
													// communication radio
													// button
	private JRadioButton performingArtsRadioButton; // A course info view has-a
													// performing arts radio
													// button
	private JRadioButton physicalEducationAndNutritionRadioButton; // A course
																	// info view
																	// has-a
																	// physical
																	// education
																	...
																	// radio
																	// button
	private JRadioButton otherCreativeArtsAndElectivesRadioButton; // A course
																	// info view
																	// has-a
																	// other
																	// creative
	...
	private ButtonGroup courseTypeButtonGroup; // A course info view has-a
												// course type button group
	private JLabel courseTypeError; // A course info view has-a course type
									// error label

	// Available classes retrieval path IV
	private JTextField availableClassesRetrievalPath; // A course info view
														// has-a available
														// classes retrieval
														// path text field

	// Buttons IVs
	private JButton backButton; // A course info view has-a back button
	private JButton csvTemplateButton; // A course info view has-a csv template
										// button
	private JButton saveButton; // A course info view has-a save button
	private JButton nextButton; // A course info view has-a next button
	private JButton buildPlannerButton; // A course info view has-a build
										// planner button

	// Course number IVs
	private int totalCourses; // A course info view has-a total number of
								// courses the student will input
	...
	public CourseInfoView()
	{
		...
		courseNamePanel
				.setLayout(new BoxLayout(courseNamePanel, BoxLayout.X_AXIS));
		...
		courseHolderPanel
				.setLayout(new BoxLayout(courseHolderPanel, BoxLayout.Y_AXIS));
		...
		requiredCoursePanel.setLayout(
				new BoxLayout(requiredCoursePanel, BoxLayout.Y_AXIS));
		...
		JPanel requiredButtonsPanel = new JPanel(
		...
		JPanel requiredCourseErrorPanel = new JPanel(
		...
		// Add the course name section and required course section tightly next
		// to each other
		...
		courseTypePanel
				.setLayout(new BoxLayout(courseTypePanel, BoxLayout.Y_AXIS));
		...
		ctRadioButtonsPanel.setLayout(
				new BoxLayout(ctRadioButtonsPanel, BoxLayout.Y_AXIS));
		...
		environmentalScienceRadioButton = new JRadioButton(
				"Environmental Science");
		otherScienceRadioButton = new JRadioButton("Other Science");
		computerScienceRadioButton = new JRadioButton("Computer Science");
		informationTechnologyRadioButton = new JRadioButton(
				"Information Technology");
		computerInformationSystemsRadioButton = new JRadioButton(
				"Computer Information Systems");
		cybersecurityAndInfoAssuranceRadioButton = new JRadioButton(
				"Cybersecurity and Information Assurance");
		dataScienceAndAnalyticsRadioButton = new JRadioButton(
				"Data Science and Analytics");
		softwareEngineeringAndDevelopmentRadioButton = new JRadioButton(
				"Software Engineering and Development");
		computerEngineeringRadioButton = new JRadioButton(
				"Computer Engineering");
		otherTechRadioButton = new JRadioButton("Other Tech");
		civilEngineeringRadioButton = new JRadioButton("Civil Engineering");
		mechanicalEngineeringRadioButton = new JRadioButton(
				"Mechanical Engineering");
		electricalEngineeringRadioButton = new JRadioButton(
				"Electrical Engineering");
		chemicalEngineeringRadioButton = new JRadioButton(
		...
		justiceAdministrationRadioButton = new JRadioButton(
		...
		visualArtsAndDesignRadioButton = new JRadioButton(
		...
		physicalEducationAndNutritionRadioButton = new JRadioButton(
				"Physical Education and Nutrition");
		otherCreativeArtsAndElectivesRadioButton = new JRadioButton(
		...
		JRadioButton[] courseTypeRadioButtons = { biologyRadioButton,
				chemistryRadioButton, physicsRadioButton,
		...
		JPanel courseTypeErrorPanel = new JPanel(
				new FlowLayout(FlowLayout.CENTER, 0, 0));
		...
		JPanel shareInstructionsWrapper = new JPanel(
				new FlowLayout(FlowLayout.CENTER, 0, 0));
		...
		shareInstructionsWrapper
				.setMaximumSize(shareInstructionsWrapper.getPreferredSize());

		JPanel sharePathInfoPanel = new JPanel();
		sharePathInfoPanel
				.setLayout(new BoxLayout(sharePathInfoPanel, BoxLayout.X_AXIS));
		...
		availableClassesRetrievalPath
				.setPreferredSize(availableClassesPathSize);
	...
	/**
	 * Purpose: To prevent the error labels from resizing when the error
	 * messages are updated, this method locks the size of the given error label
	...
	/**
	 * Purpose: To set the current course number and total courses for the
	 * course info view to the given values and update the course number label
	 * to reflect the new current course number and total courses
	 * 
	 */
	public void setCourseNumLabel(int newCurrentCourseNum)
	{
		courseNumberLabel.setText(
				"Course " + newCurrentCourseNum + " of " + totalCourses);
	}

	/**
	 * Purpose: To set the total number of courses the student will input
	 * 
	 * @param newTotalCourses The new numer of total courses the student will
	 *                        input
	 */
	...
	/**
	 * Purpose: To return the course name that the student will input in the
	 * course info view
	 * 
	 * @return courseName The course name that the student will input in the
	 *         course info view
	 */
	...
	/**
	 * Purpose: To return the value of if the course is required or not that the
	 * student will select
	...
	/**
	 * Purpose: To return the course type that the student will input in the
	 * course info view as a RadioButton
	 * 
	 * @return courseType The course type that the student will input in the
	 *         course info view as a RadioButton
	 */
	...
	/**
	 * Purpose: To return the available classes retrieval path that the student
	 * will input in the course info view
	 * 
	 * @return availableClassesRetrievalPath The available classes retrieval
	 *         path that the student will input in the course info view
	 */
	...
	/**
	 * Purpose: To reset the fields in the course info view to their default
	 * values
	 * 
	 */
	...
	/**
	 * Purpose: To set the course name error message in the course info view to
	 * the given value
	 * 
	 * @param errorMessage The error message to set for the course name error
	 *                     message in the course info view
	 */
	...
	/**
	 * Purpose: To set the required course error message in the course info view
	 * to the given value
	 * 
	 * @param errorMessage The error message to set for the required course
	 *                     error message in the course info view
	 */
	...
	/**
	 * Purpose: To set the course type error message in the course info view to
	 * the given value
	 * 
	 * @param errorMessage The error message to set for the course type error
	 *                     message in the course info view
	 */
