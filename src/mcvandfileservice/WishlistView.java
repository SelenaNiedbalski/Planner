 ...
 * 
 *         Responsibilities of class: To represent the wishlist view of the
 *         application and all of its components, as well as provide getters and
 *         setters for the app controller and the components that the controller
...
{
	// Instance Variables
	private AppController appController; // A wishlist view has-an app
											// controller

	// Times IVs
	private JTextField monStartOfDay; // A wishlist view has-a desired start
										// time for Monday
	private JTextField monEndOfDay; // A wishlist view has-a desired end time
									// for Monday
	private JTextField tuesStartOfDay; // A wishlist view has-a desired start
										// time for Tuesday
	private JTextField tuesEndOfDay; // A wishlist view has-a desired end time
										// for Tuesday
	private JTextField wedStartOfDay; // A wishlist view has-a desired start
										// time for Wednesday
	private JTextField wedEndOfDay; // A wishlist view has-a desired end time
									// for Wednesday
	private JTextField thursStartOfDay; // A wishlist view has-a desired start
										// time for Thursday
	private JTextField thursEndOfDay; // A wishlist view has-a desired end time
										// for Thursday
	private JTextField friStartOfDay; // A wishlist view has-a desired start
										// time for Friday
	private JTextField friEndOfDay; // A wishlist view has-a desired end time
									// for Friday
	private JTextField satStartOfDay; // A wishlist view has-a desired start
										// time for Saturday
	private JTextField satEndOfDay; // A wishlist view has-a desired end time
									// for Saturday
	private JTextField sunStartOfDay; // A wishlist view has-a desired start
										// time for Sunday
	private JTextField sunEndOfDay; // A wishlist view has-a desired end time
									// for Sunday

	// Time Error IVs
	private JLabel monError; // A wishlist view has-a JLabel for errors in the
								// Monday time inputs
	private JLabel tuesError; // A wishlist view has-a JLabel for errors in the
								// Tuesday time inputs
	private JLabel wedError; // A wishlist view has-a JLabel for errors in the
								// Wednesday time inputs
	private JLabel thursError; // A wishlist view has-a JLabel for errors in the
								// Thursday time inputs
	private JLabel friError; // A wishlist view has-a JLabel for errors in the
								// Friday time inputs
	private JLabel satError; // A wishlist view has-a JLabel for errors in the
								// Saturday time inputs
	private JLabel sunError; // A wishlist view has-a JLabel for errors in the
								// Sunday time inputs

	// Break time IVs
	private JTextField minBreakTime; // A wishlist view has-a desired minimum
										// break time in minutes
	private JTextField maxBreakTime; // A wishlist view has-a desired maximum
										// break time in minutes

	// Campus location IV
	private JTextField campusLocation; // A wishlist view has-a desired campus
										// location

	// Desired SharePath IV
	private JTextField topThreeSchedulesDestinationPath; // A wishlist view
															// has-a desired
															// share path for
															// the top three
															// schedules
	...
	// Button IVs
	private JButton backButton; // A wishlist view has-a back button to return
								// to the previous view
	private JButton saveButton; // A wishlist view has-a save button to save the
								// user's wishlist preferences
	private JButton continueButton; // A wishlist view has-a continue button to
									// continue to the next view after inputting
	...
	public WishlistView()
	{
		...
		JPanel timetableInstructionsWrapper = new JPanel(
		...
		// (1) Day labels in a Y_AXIS box, (2) 8x2 time grid, (3) Error JLabels
		// in a wider Y_AXIS box
		...
		dayLabelsPanel
				.setLayout(new BoxLayout(dayLabelsPanel, BoxLayout.Y_AXIS));

		JPanel errorLabelsPanel = new JPanel();
		errorLabelsPanel.setOpaque(false);
		errorLabelsPanel
				.setLayout(new BoxLayout(errorLabelsPanel, BoxLayout.Y_AXIS));
		...
		java.util.function.Function<JComponent, JPanel> fixedRowCell = (
				comp) -> {
			JPanel p = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0));
			p.setOpaque(false);
		...
		java.util.function.Function<JComponent, JPanel> fixedErrorCell = (
				comp) -> {
		...
		timetableRowWrapper.setLayout(
				new BoxLayout(timetableRowWrapper, BoxLayout.X_AXIS));
		...
		breakTimesInstructionsLabel
				.setBorder(BorderFactory.createEmptyBorder());
		breakTimesInstructionsLabel.setColumns(32);

		JPanel breakInstructionsWrapper = new JPanel(
				new FlowLayout(FlowLayout.CENTER, 0, 0));
		...
		breakTimesPanel
				.setLayout(new BoxLayout(breakTimesPanel, BoxLayout.X_AXIS));
		...
		JPanel campusLocationLabelWrapper = new JPanel(
				new FlowLayout(FlowLayout.CENTER, 0, 0));
		...
		campusLocationPanel.setLayout(
				new BoxLayout(campusLocationPanel, BoxLayout.X_AXIS));
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for Monday
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for Monday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for
	 *                                      Tuesday is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for Tuesday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for
	 *                                      Wednesday is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for
	 *                                      Wednesday is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for
	 *                                      Thursday is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for Thursday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for Friday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for Friday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time for
	 *                                      Saturday is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time for Saturday
	 *                                      is not in hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired start time is not in
	 *                                      hh:mm format
	 */
	 ...
	 * @throws IncorrectTimeFormatException if the desired end time is not in
	 *                                      hh:mm format
	 */
	 ...
	 * 
	 * @return topThreeSchedulesDestinationPath The desired share path for the
	 *         top three schedules
	 */
	...
	/**
	 * Purpose: To set the error message for the desired start and end time for
	 * Monday
	 * 
	 * @param errorMessage The error message for the desired start and end time
	 *                     for Monday
	 */
	 ...
	 * 
	 * @throws IncorrectTimeFormatException if the time is not in the correct
	 *                                      format or is not a valid time
	 */
	private void validateHHMM(String timeText)
