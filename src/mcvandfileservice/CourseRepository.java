 ...
 * 
 *         Responsibilities of class: To represent the course repository that
 *         will store the partial course information and build the final course
 *         objects based on the partial info and user input, and to set and get
 *         the destination path for the top three schedules file
 * 
 */
...
{
	// Instance Variables
	private List<PartialCourse> storedClasses; // A course repository has-many
												// partial courses
	private Path topThreeSchedulesDestinationPath; // A course repository has-a
													// destination path
	private UserDataRepository userDataRepository; // A course repository has-a
													// user data repository

	// Constructor
	/**
	 * Purpose: To construct a CourseRepository a default empty storedClasses
	 * list and the given userData repository to grab the destination schedule
	 * path
	 * 
	 * @param userDataRepository The user data repository to grab the
	 *                           destination schedule path from
	 * 
	 */
	...
	// Getters
	/**
	 * Purpose: To set the top three schedules destination path based on the
	 * user data repository
	 * 
	 * @param userDataRepository The user data repository to grab the
	 *                           destination schedule path from
	...
	{
		topThreeSchedulesDestinationPath = userDataRepository
				.getTopThreeSchedulesDestinationPath();
	}

	/**
	 * Purpose: To return the path where the top three schedules file will be
	 * saved to
	 * 
	 * @return topThreeSchedulesDestinationPath The path where the top three
	 *         schedules file will be saved to
	 */
	...
	// Methods
	/**
	 * Purpose: To save the course information that the student will input to a
	 * file
	 * 
	...
	/**
	 * Purpose: To create course objects based on partial info from partial
	 * course and input info from user input
	 * 
	 * @param courseType The course type that the student will input
	 * @param required   Whether the course is a required course or not that the
	 *                   student will input
	 * @param difficulty The course difficulty that the student will input
	 * @return finalCourses The list of course objects created based on the
	 *         partial info from partial course and input info from user input
	 * 
	 */
	public List<Course> buildFinalCourses(String courseName, String courseType,
			boolean required, double difficulty)
	{
	...
	/**
	 * Purpose: To clear the stored classes in the course repository if the user
	 * hits back on the course info view
	 * 
	 */
