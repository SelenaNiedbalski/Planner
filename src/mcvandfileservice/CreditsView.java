 ...
 * 
 *         Responsibilities of class: To represent the credits view of the
 *         application, which allows users to input their minimum and maximum
 *         required credits for the semester and navigate to other views of the
 *         application.
 * 
...
public class CreditsView extends JFrame
{
	...
	// Credits IVs
	private JTextField minCreditsInput; // A credits view has-a minimum required
										// credits input field
	private JTextField maxCreditsInput; // A credits view has-a maximum required
										// credits input field

	// Credits Errors IVs
	private JLabel minCreditsError; // A credits view has-a minimum required
									// credits error label
	private JLabel maxCreditsError; // A credits view has-a maximum required
									// credits error label

	// Buttons IVs
	private JButton backButton; // A credits view has-a back button
	private JButton saveButton; // A credits view has-a save button
	private JButton continueButton; // A credits view has-a continue button
	...
	public CreditsView()
	{
		...
		JTextArea instructionsLabel = new JTextArea(
				"Please enter the minimum and maximum credits you are required to take below:");
		...
		instructionsLabel.setMaximumSize(new Dimension(Integer.MAX_VALUE,
				instructionsLabel.getPreferredSize().height));
		instructionsPanel.add(instructionsLabel);

		// Min Credits Panel
		JPanel minCreditsPanel = new JPanel();
		minCreditsPanel
				.setLayout(new BoxLayout(minCreditsPanel, BoxLayout.X_AXIS));
		...
		maxCreditsPanel
				.setLayout(new BoxLayout(maxCreditsPanel, BoxLayout.X_AXIS));
	...
	/**
	 * Purpose: To set the error message for the minimum required credits input
	 * field
	 * 
	 * @param errorMessage The error message to be set for the minimum required
	 *                     credits input field
	 */
	...
	/**
	 * Purpose: To set the error message for the maximum required credits input
	 * field
	 * 
	 * @param errorMessage The error message to be set for the maximum required
	 *                     credits input field
	 */
