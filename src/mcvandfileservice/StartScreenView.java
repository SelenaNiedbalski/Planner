...
public class StartScreenView extends JFrame
{
    ...
    /**
     * Purpose: To construct a StartScreenView with a background image and a start button
     */
    public StartScreenView()
    {
		...
		BackgroundPanel backgroundPanel = new BackgroundPanel(getClass()
				.getResource("/images/StartScreen.png"));
