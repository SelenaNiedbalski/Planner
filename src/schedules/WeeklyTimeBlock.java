 ...
 *         a class schedule, containing the days of the week, start time, end
...
public class WeeklyTimeBlock
{
	...
	private HashMap<DayOfWeek, List<LocalTime[]>> timesPerDay; // A weekly time
																// block has-a
																// hashmap that
																// maps days of
																// the week to
	 ...
	 * 
	 * @return containsDay if the time block contains the day and !containDay if
	 *         not
	 */
	...
	/**
	 * Purpose: To find the EARLIEST start time for a specific day in the time
	 * block
	 * 
	 ...
	 * @return true if there is a time conflict between weeklytimeblocks and
	 *         false if not
	 */
